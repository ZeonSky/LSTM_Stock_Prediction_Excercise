# -*- coding: utf-8 -*-
"""
Created on Sun Sep 15 15:59:31 2019
...
print(check_output(["ls", "D:\Kaggle\RL Stock\Data\Stocks"]).decode("utf8"))
# ???
import os
os.chdir('D:\Kaggle\RL Stock\Data\Stocks')
...
# LSTM's do not solve time series prediction. The prediction on one time step is not much better then the lag model. 
# If we increase the number of time steps predicted the performance does not degrade as fast as other, more traditional, methods. 
# However in this case we have an increase of around a factor of 4.5 in error. 
# This grows super-linear with the number of time steps we try to predict.
